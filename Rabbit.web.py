...
if choice=="sign in":
    ...
    if signin:
            ...
            nav = option_menu(menu_title=None,   options=["Home", "Friend's","Post's", "Setting's","About us"],icons=["house","person", "book", "gear","info"],menu_icon="cast",default_index=2,orientation="vertical",styles={
            ...
            if nav =="Home":
                ...
                with col1:
                    ...
                    if nimg is not None:
                        ...
                        st.markdown(f'<img src="{imgc}" width="200" style="border-radius:50%;">', unsafe_allow_html=True)
